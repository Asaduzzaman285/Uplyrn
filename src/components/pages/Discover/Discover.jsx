...
const Discover = () => {
    return (
        <div>
            ...
            <p className="text-xl font-semibold tracking-wider text-center pb-8">Students are viewing. What you find just might interest and inspire you. Tremendously.</p>
            <div>
                <CategorieItem />
            </div>
        </div>
