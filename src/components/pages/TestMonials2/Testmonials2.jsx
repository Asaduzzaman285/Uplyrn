...
import img from '../../../assets/testmonials.jpg';

const Testmonials2 = () => {
    return (
        <div>
            <Parallax strength={300} bgImage={img} className="h-[100vh] object-contain w-full mt-14">
                <div className="flex justify-center items-center flex-col h-screen w-full">
                    <h1 className="text-5xl tracking-wider text-center font-bold text-white">Our Clients Say</h1>
                    <Typed
                        className="text-white text-center"
                        strings={['Read what our students are saying about their experience learning on Uplyrn.']}
                        typeSpeed={30}
                        style={{
                            fontSize: '30px',
                            fontWeight: 'bold',
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-items-center py-10 px-32">
                        <div className=" bg-white p-10 rounded-2xl transition-all duration-200 ease-in-out hover:scale-125">
                            ...
                            <div className="flex items-center justify-center py-4">
                                <svg className="w-8 h-8 text-[#FFAE13]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div className=" bg-white p-10 rounded-2xl transition-all duration-200 ease-in-out hover:scale-125">
                            ...
                            <h4 className="text-xl text-center">Kieu D</h4>
                        </div>
                    </div>
                </div>
            </Parallax>
